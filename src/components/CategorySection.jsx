...
const CategorySection = () => {
  ...
  return (
    <section id="categories" className="py-16 md:py-32">
          ...
          {categories.map((category, index) => {
            ...
            return (
              <motion.div
                ...
                className="group p-6 md:p-10 rounded-3xl bg-surface border border-gray-100 hover:shadow-soft-hover transition-all duration-500 hover:-translate-y-2 relative overflow-hidden"
              >
                ...
                <h3 className="text-xl md:text-2xl font-serif text-text mb-3">{category.name}</h3>
